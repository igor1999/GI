 ...
 */
namespace GI\Meta\ClassMeta\Behaviour\Traits;
...
class Traits extends Immutable implements TraitsInterface
{
    use OwnerTrait;
    ...
    public function __construct(ClassMetaInterface $owner)
    {
        ...
        foreach ($this->owner->getReflection()->getTraitNames() as $traitName) {
            $this->_setByName($traitName);
        }
    }
}