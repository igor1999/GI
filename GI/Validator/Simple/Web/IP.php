...
class IP extends AbstractSimple implements IPInterface
{
    /**
     * @var int
     */
    ...
    protected function doValidation()
    {
        ...
        return (bool)filter_var($this->getSource(), FILTER_VALIDATE_IP, $options);
    }
    ...
    {
        return $this->getGiServiceLocator()->translate(GlossaryInterface::class, Glossary::class,DefaultMessages::IP);
    }
}