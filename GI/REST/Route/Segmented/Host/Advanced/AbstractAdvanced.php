 ...
 */
namespace GI\REST\Route\Segmented\Host\Advanced;

use GI\REST\Route\Segmented\Host\Host;
...
abstract class AbstractAdvanced extends Host implements AdvancedInterface
{
    /**
