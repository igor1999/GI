 ...
 */
namespace GI\REST\Route\Segmented\UriPath\Advanced\Get;

use GI\REST\Route\Segmented\UriPath\Advanced\AbstractAdvanced;

use GI\REST\Route\Simple\Method\Get\GetInterface as MethodInterface;
use GI\REST\Route\Segmented\Behaviour\Constraint\ConstraintsInterface;

class Get extends AbstractAdvanced implements GetInterface
{
    /**
     * Get constructor.
