 ...
 */
giClient.core.ajax.configurator.Json = function()
{
    ...
    {
        this.reset().getSender().setRequestTypeToJson();
    ...
    let createBody = function(query)
    {
        ...
        if (typeof(query) === 'string') {
            result = query
        } else if ((query instanceof Object) || (query instanceof Array)) {
            result = JSON.stringify(query);
        } else {
            throw new Error('Query type for JSON request should be a string, Object or Array');
        }
