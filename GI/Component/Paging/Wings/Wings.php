 ...
 */
namespace GI\Component\Paging\Wings;

use GI\Component\Paging\Base\AbstractPaging;
use GI\ClientContents\Paging\Wings\Paging as PagingModel;
use GI\Component\Paging\Base\View\Chain\Widget;

use GI\Component\Paging\Base\View\Chain\WidgetInterface;
use GI\ClientContents\Paging\Wings\PagingInterface as PagingModelInterface;
use GI\Component\Paging\Base\ViewModel\ViewModelInterface;

class Wings extends AbstractPaging implements WingsInterface
{
    /**
     * @var WidgetInterface
     */
