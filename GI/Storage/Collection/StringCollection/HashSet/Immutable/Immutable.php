 ...
 */
namespace GI\Storage\Collection\StringCollection\HashSet\Immutable;

use GI\Storage\Collection\Behaviour\Service\StringCollection\HashSet\HashSet as Service;

use GI\ServiceLocator\ServiceLocatorAwareTrait;
use GI\Storage\Collection\StringCollection\CollectionTrait;

use GI\Storage\Collection\Behaviour\Service\StringCollection\HashSet\HashSetInterface as ServiceInterface;
use GI\Storage\Collection\Behaviour\Option\StringCollection\HashSet\HashSetInterface as OptionInterface;
...
class Immutable implements ImmutableInterface
{
     ...
     * @throws \Exception
     */
    public function findPositionOfItem(string $item)
    {
     ...
     * @throws \Exception
     */
    protected function set(string $key, string $item, int $position = null)
    {
     ...
     * @throws \Exception
     */
    protected function insertBefore(string $key, string $anchor, string $item)
    {
