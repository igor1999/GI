 ...
 */
namespace GI\Storage\Collection\Behaviour\Service\BoolCollection\HashSet;
...
{
    use OrderTrait, UniqueTrait, BoolStrictTrait, KeyFormatTrait;
    ...
    {
        return $this->getGiServiceLocator()->getStorageFactory()->getOptionFactory()->createBoolHashSet();
    }
