 ...
 */
namespace GI\Storage\Collection\Behaviour\Service\MixedCollection\HashSet;
...
class HashSet extends AbstractService implements HashSetInterface
{
    ...
    {
        return $this->getGiServiceLocator()->getStorageFactory()->getOptionFactory()->createMixedHashSet();
    }
