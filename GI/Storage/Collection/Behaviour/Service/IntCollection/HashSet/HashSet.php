 ...
 */
namespace GI\Storage\Collection\Behaviour\Service\IntCollection\HashSet;
...
use GI\Storage\Collection\Behaviour\Option\IntCollection\HashSet\HashSetInterface as OptionInterface;

class HashSet extends AbstractService implements HashSetInterface
{
    use OrderTrait, UniqueTrait, IntBoundsTrait, KeyFormatTrait;
    ...
    {
        return $this->getGiServiceLocator()->getStorageFactory()->getOptionFactory()->createIntHashSet();
    }
