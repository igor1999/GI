 ...
 */
namespace GI\Storage\Collection\BoolCollection\HashSet\Immutable;

use GI\Storage\Collection\Behaviour\Service\BoolCollection\HashSet\HashSet as Service;

use GI\ServiceLocator\ServiceLocatorAwareTrait;
use GI\Storage\Collection\BoolCollection\CollectionTrait;

use GI\Storage\Collection\Behaviour\Service\BoolCollection\HashSet\HashSetInterface as ServiceInterface;
use GI\Storage\Collection\Behaviour\Option\BoolCollection\HashSet\HashSetInterface as OptionInterface;
...
class Immutable implements ImmutableInterface
{
    ...
    /**
     * @param string $key
     * @param bool|null|mixed $default
     * @return bool|null|mixed
     */
    public function getOptional(string $key, $default = false)
    {
        try {
            $result = $this->get($key);
     ...
     * @throws \Exception
     */
    public function findPositionOfItem(bool $item = null)
    {
     ...
     * @throws \Exception
     */
    protected function set(string $key, bool $item = null, int $position = null)
    {
     ...
     * @throws \Exception
     */
    protected function insertBefore(string $key, string $anchor, bool $item = null)
    {
