...
use GI\Security\Captcha\ImageText\ImageText;


use GI\Security\Captcha\Base\CaptchaInterface;
...
class Factory extends AbstractFactory implements FactoryInterface
{
    ...
    {
        $this->getTemplateClasses()->add(CaptchaInterface::class);

        $this->set(ImageText::class);
    }
}