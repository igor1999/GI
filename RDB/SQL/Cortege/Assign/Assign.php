 ...
 */
namespace GI\RDB\SQL\Cortege\Assign;

use GI\RDB\SQL\Cortege\AbstractCortege;

use GI\RDB\Meta\Table\TableInterface;

class Assign extends AbstractCortege implements AssignInterface
{
    /**
     * Assign constructor.
     * @param array $items
    ...
    {
        return implode(static::SEPARATOR, $this->createAssignList());
    }
}