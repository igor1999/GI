...
class LessThanOrEqual extends LessThan implements LessThanOrEqualInterface
{
    /**
     * @return bool
     */
    ...
    {
        return $this->getSource() <= $this->getMaximum();
    }
    ...
    protected function getMessage()
    {
        return $this->giTranslate(
            GlossaryInterface::class, Glossary::class,DefaultMessages::LESS_THAN_OR_EQUAL
        );
    }
}