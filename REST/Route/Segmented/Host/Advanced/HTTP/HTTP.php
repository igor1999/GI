 ...
 */
namespace GI\REST\Route\Segmented\Host\Advanced\HTTP;

use GI\REST\Route\Segmented\Host\Advanced\AbstractAdvanced;

use GI\REST\Route\Simple\Protocol\HTTP\HTTPInterface as ProtocolInterface;
use GI\REST\Route\Segmented\Behaviour\Constraint\ConstraintsInterface;

class HTTP extends AbstractAdvanced implements HTTPInterface
{
    /**
     * HTTP constructor.
