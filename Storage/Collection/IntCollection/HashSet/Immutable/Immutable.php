...
use GI\Storage\Collection\Behaviour\Service\IntCollection\HashSet\HashSet as Service;
...
class Immutable implements ImmutableInterface
{
     ...
     * @throws \Exception
     */
    protected function set(string $key, int $item, int $position = null)
    {
     ...
     * @throws \Exception
     */
    protected function insertBefore(string $key, string $anchor, int $item)
    {
