 ...
 */
namespace GI\Storage\Collection\MixedCollection\HashSet\Immutable;

use GI\Storage\Collection\Behaviour\Service\MixedCollection\HashSet\HashSet as Service;

use GI\ServiceLocator\ServiceLocatorAwareTrait;
use GI\Storage\Collection\MixedCollection\CollectionTrait;

use GI\Storage\Collection\Behaviour\Service\MixedCollection\HashSet\HashSetInterface as ServiceInterface;
use GI\Storage\Collection\Behaviour\Option\MixedCollection\HashSet\HashSetInterface as OptionInterface;
...
class Immutable implements ImmutableInterface
{
     ...
     * @throws \Exception
     */
    protected function set(string $key, $item, int $position = null)
    {
     ...
     * @throws \Exception
     */
    protected function insertBefore(string $key, string $anchor, $item)
    {
