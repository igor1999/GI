 ...
 */
namespace GI\DOM\HTML\Element\Document\Meta\ContentType;
...
class ContentType extends Meta implements ContentTypeInterface
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $contentType = self::DEFAULT_CONTENT_TYPE)
    {
        parent::__construct();
